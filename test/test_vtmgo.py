...
class TestVtmGo(unittest.TestCase):
    ...
    @unittest.skipUnless(Authentication.has_credentials(), 'Skipping since we have no credentials.')
    def test_login(self):
