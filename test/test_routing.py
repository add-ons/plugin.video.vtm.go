...
class TestRouting(unittest.TestCase):
    ...
    def test_catalog_program_menu(self):
        addon.run([routing.url_for(addon.show_catalog_program, program='e892cf10-5100-42ce-8d59-6b5c03cc2b96'), '0', ''])

    def test_catalog_program_season_menu(self):
        addon.run([routing.url_for(addon.show_catalog_program_season, program='e892cf10-5100-42ce-8d59-6b5c03cc2b96', season=-1), '0', ''])
    ...
    def test_play_episode(self):
        addon.run([routing.url_for(addon.play, category='episodes', item='ae0fa98d-6ed5-4f4a-8581-a051ed3bb755'), '0', ''])
