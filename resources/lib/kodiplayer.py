# -*- coding: utf-8 -*-
"""A KodiPlayer that we can use to monitor playback status"""
...
_LOGGER = logging.getLogger('kodiplayer')


class KodiPlayer(xbmc.Player):
    """A helper class for the Kodi Player to check if Playback has started"""
